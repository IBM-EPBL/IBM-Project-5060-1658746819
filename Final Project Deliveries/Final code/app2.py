...
app = Flask(__name__)
app.Secret_key='a'
conn=ibm_db.connect("DATABASE=bludb;HOSTNAME=2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=30756;SECURITY=SSL;SSLServerCertificate=Certificate.crt;UID=pll77939;PWD=jvMmDqSUPH8WULWC",'','')
@app.route('/')
def home():
